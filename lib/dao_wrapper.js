...
module.exports = (function(){
    var audit_dao = function(sequelizeDao, auditDaoFactoryWrapper){
        ...
        for(var i=0;i<sequelizeDaoKeys.length;i++){
            var sequelizeDaoValue = sequelizeDao[sequelizeDaoKeys[i]];
            if(sequelizeDaoValue !== undefined){
                this[sequelizeDaoKeys[i]] = sequelizeDaoValue;
            }
        }
        var sequelizeDaoSelectedValues = sequelizeDao.selectedValues;
        for(var selectedValueName in sequelizeDaoSelectedValues){
            var sequelizeDaoValue = sequelizeDaoSelectedValues[selectedValueName];
            if(sequelizeDaoValue !== undefined){
                this[selectedValueName] = sequelizeDaoValue;
            }
        }
        this.values = sequelizeDao.values;
        this.selectedValues = sequelizeDao.selectedValues;
    ...
    function syncDao(self){
        ...
        var sequelizeDaoKeys = Object.keys(sequelizeDaoValues);
        for(var i=0;i<sequelizeDaoKeys.length;i++){
            if(self[sequelizeDaoKeys[i]] !== null && (typeof self[sequelizeDaoKeys[i]] !== 'undefined')){
